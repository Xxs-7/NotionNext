    ...
    <>
      ...
      <div className='hidden lg:flex justify-between items-end mt-10 font-medium text-black duration-500 dark:text-gray-300 pt-3 space-x-2 overflow-x-auto'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          {/* 跳转页码 */}
          <div className='bg-white hover:bg-gray-100 dark:hover:bg-primary  dark:bg-[#1e1e1e] h-10 border dark:border-gray-600 flex justify-center items-center rounded-lg group hover:border-primary transition-all duration-200'>
            <input
              value={value}
              className='w-0 group-hover:w-20 bg-[#1e1e1e] group-hover:px-3 transition-all duration-200 border-none outline-none h-full rounded-lg'
              onInput={handleInputChange}></input>
            <div
              onClick={jumpToPage}
              className='cursor-pointer hover:bg-primary dark:bg-[#1e1e1e] dark:hover:bg-primary white px-4 py-2 group-hover:px-2 group-hover:mx-1 group-hover:rounded '>
        ...
        <Link
          ...
          <div className='hover:border-primary dark:hover:border-primary relative w-24 h-10 flex items-center transition-all duration-200 justify-center py-2 px-2 bg-white dark:bg-[#1e1e1e] border dark:border-gray-600 rounded-lg cursor-pointer group'>
  ...
  return (
    <Link
      ...
      className={
        ...
        ' hover:border-primary dark:hover:bg-primary dark:border-gray-600 px-4 border py-2 rounded-lg drop-shadow-sm duration-200 transition-colors'
      }>
      {page}
    </Link>
  )
