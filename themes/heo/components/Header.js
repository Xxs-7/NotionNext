    ...
    <>
      ...
      <nav
        ...
        <div className='flex h-full mx-auto justify-between items-center max-w-[86rem] px-6'>
          ...
          <div
            id='nav-bar-swipe'
            className={`hidden lg:flex flex-col flex-grow items-center justify-center relative w-full h-full `}>
            <div
          ...
          {/* 右侧固定 */}
          <div className='flex flex-shrink-0 justify-end items-center w-24'>
